...
// Dynamically checked borrow rules. For data structures like a graph with a cycle.
...
// Ref is essentially a smart pointer. A pointer with additional semantics fwhen dropped
// Adjusts the refcell refstate as there is one less reference to it
